...
class AlienInvasion:
    ...
    def _create_fleet(self):
        ...
        #determine the amount of aliens that fit in the screen at once
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            #get rid of any remainding alies and bullets
            #in order to reset clean
            self.aliens.empty()
            self.bullets.empty()
    ...
    def _check_bullet_alien_collisions(self):
        ...
        #remove any bullets and aliens collided
